...

{
  ...
  networking.wireguard = {
    ...
    #  postSetup = ''
    #    # Setup route
    #    ${pkgs.iproute2}/bin/ip route add 74.208.44.130 via 10.0.0.1 dev eth0
    #
    ...
    #      -m comment --comment "block non-wg0 access to 10.127.0.3" \
    #      -j DROP
    #  '';
    #  postShutdown = ''
    #    ${pkgs.iproute2}/bin/ip route del 74.208.44.130 via 10.0.0.1 dev eth0 || true
    #
    ...
    #    ${pkgs.iproute2}/bin/ip route add 142.167.46.223 via 10.0.0.1 dev eth0 table 101
    #    ${pkgs.iproute2}/bin/ip rule add fwmark 0xca7f table 101
    #    ${pkgs.iproute2}/bin/ip route add default dev wg1 table 101
    #
    ...
    #    ${pkgs.iptables}/bin/iptables -t mangle -A POSTROUTING \
    #      -o eth0 -m mark --mark 0xca7f \
    #      -m comment --comment "wg1 save mark" \
    #      -j CONNMARK --save-mark || true
    #
    #    ${pkgs.iptables}/bin/iptables -A FORWARD -i wg1 -o eth0 -j ACCEPT
    #  '';
    #  postShutdown = ''
    #    ${pkgs.iproute2}/bin/ip route del 142.167.46.223 via 10.0.0.1 dev eth0 table 101 || true
    ...
    #      -j CONNMARK --save-mark || true
    #
    #    ${pkgs.iptables}/bin/iptables -D FORWARD -i wg1 -o eth0 -j ACCEPT || true
    #  '';
    #  peers = [
    #    {
