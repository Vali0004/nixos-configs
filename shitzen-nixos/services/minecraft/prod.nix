...

{
  ...
  "mods/modernfix.jar" = fetchurl rec {
  ...
  "mods/memoryleakfix.jar" = fetchurl rec {
  ...
  "mods/Debugify.jar" = fetchurl rec {
  ...
  "mods/NoChatReports.jar" = fetchurl rec {
  ...
  "mods/netherportalfix.jar" = fetchurl rec {
  ...
  "mods/letmedespawn.jar" = fetchurl rec {
  ...
  # Audio
  "mods/voicechat.jar" = fetchurl rec {
  ...
  "mods/audioplayer.jar" = fetchurl rec {
  ...
  "mods/vcinteraction.jar" = fetchurl rec {
  ...
  "mods/sound-physics-remastered.jar" = fetchurl rec {
  ...
  "mods/geyser-fabric.jar" = fetchurl rec {
  ...
  "mods/Floodgate.jar" = fetchurl rec {
  ...
  "mods/ViaFabric.jar" = fetchurl rec {
  ...
  "mods/ViaBackwards.jar" = fetchurl rec {
  ...
  "mods/ViaRewind.jar" = fetchurl rec {
  ...
  "mods/ViaVersion.jar" = fetchurl rec {
  ...
  "mods/resourcepackchecker.jar" = fetchurl rec {
  ...
  "mods/SnowUnderTrees.jar" = fetchurl rec {
  ...
  # Fun
  "mods/polymer-bundled.jar" = fetchurl rec {
  ...
  "mods/gamingbarns-guns.jar" = fetchurl rec {
  ...
  "mods/modern-guns.jar" = fetchurl rec {
  ...
  "mods/katters-structures.jar" = fetchurl rec {
  ...
  "mods/qraftys-end-villages.jar" = fetchurl rec {
