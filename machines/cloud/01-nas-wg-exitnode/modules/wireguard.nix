...
in {
  ...
  networking.wireguard.interfaces.wg0 = {
    ...
    postSetup = ''
      ...
      for x in 25 80 143 465 587 993 995 3700 4100 6697 8080 8900; do
      ...
      # Forward Forgejo ssh for shitzen as 22 (comes from 2222)
    ...
    postShutdown = ''
      ...
      for x in 25 80 465 587 993 995 3700 4100 6697 8080 8900; do
